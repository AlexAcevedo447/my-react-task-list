    ...
    return (
        <Stack width="100%" divider={divider} height="80%" display="flex" spacing="4" align="stretch">
            <Flex width="100%" flexDirection="row" alignItems="center" justifyContent="space-around" height="510px">
                <Heading color={fontColor} width="30%" textAlign="center" as="h2">About Developer</Heading>
                <PersonCard image={meImg} cardBody={developerCardProps} />
            </Flex>

            <Flex width="100%" flexDirection="row" alignItems="center" justifyContent="space-around" height="510px">
                <GeneralContentCard cardBody={functionalitiesCardProps} />
                <Heading color={fontColor} width="30%" textAlign="center" as="h2">About Functionalities</Heading>
            </Flex>

            <Flex width="100%" flexDirection="row" alignItems="center" justifyContent="space-around" height="510px">
                <Heading color={fontColor} width="30%" textAlign="center" as="h2">About technologies with which this project was built</Heading>
